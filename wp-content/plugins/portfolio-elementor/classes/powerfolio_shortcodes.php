...
class Powerfolio_Shortcodes {
	...
	static function powerfolio_shortcode($atts, $content = null) {
		...
		//PS: Eles tambem sao chamados na parte do elementor. Verificar a melhor forma de incluir / ver creative portfolio
		////Isotope	
		wp_enqueue_script( 'isotope',  $assets_dir. 'vendor/isotope/js/isotope.pkgd.js', array('jquery'), '20151215', true );
		...
		if(count($portfolioposts)){    
			...
			global $post;
				...
				$retour .='<div class="elpt-portfolio">';			
					...
					$retour .='<div class="elpt-portfolio-content elpt-portfolio-content-isotope '.$portfoliostyle.' '.$zoom_effect.' '.$hover.' '.$portfoliocolumns.' '. $portfoliomargin.'">';
